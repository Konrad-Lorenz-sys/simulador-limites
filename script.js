...
// Adaptado para límites al infinito
...
function draw(){
    ...
    const stepX = Math.pow(10, Math.floor(Math.log10((xmax-xmin)/10))); 
    ...
    const stepY = Math.pow(10, Math.floor(Math.log10((ymax-ymin)/10)));
...
// --- LÓGICA DEL PUNTERO RASTREADOR Y ARRASTRE ---
...
// --- Implementación del Selector de Ejemplos ---
const EXAMPLES = [
